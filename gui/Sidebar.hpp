...
#else
	const char* cat_names[TOTAL_CATS] = { "sidebar.search", "sidebar.all", "N64 Nativos", "sidebar.games", "sidebar.emulators", "sidebar.tools", "sidebar.media", "sidebar.advanced", "sidebar.misc" };
	const char* cat_value[TOTAL_CATS] = { "_search", "_all", "N64_Nativos", "game", "emu", "tool", "media", "advanced", "_misc" };
#endif
