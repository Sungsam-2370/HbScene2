	...
	const char* mastodon)
{
	...
	cred->userLogo = new NetImageElement(directAvatarUrl != NULL ? directAvatarUrl : ((std::string("https://avatars.githubusercontent.com/u/") + githubId + "?s=100").c_str()));
